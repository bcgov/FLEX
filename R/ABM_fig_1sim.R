ABM_fig_1sim <- function(sim_out, 
  ...
  ABM.df <- sim_output(sim_out=sim_out, simul=2, numsims=numsims, yrs_sim=yrs_sim)
  ...
  ABM.TS.df <- ABM.TS %>% pivot_longer(cols = 4:(3+yrs_simul+1),names_to = "TimeStep",values_to = "Value" )
